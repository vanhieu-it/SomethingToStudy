package com.hido.somethingtosave.JavaAndJava.P02_Variables.DateAndTime;
...
public class LocalDateExample {
    public static void methodInLocalDate() {
        ...
        //Khởi tạo ngày
        LocalDate localDate = LocalDate.of(2023, 10, 26); //Dùng of() để truyền vào ngày tháng năm
        System.out.println("Ngày nào đấy: " + localDate);

        LocalDate localDate1 = LocalDate.of(2023, Month.OCTOBER, 26); //Tháng không còn là kiểu int giống như bên trên
        ...
        //Sử dụng minus()
        System.out.println("Trừ 5 ngày: " + toDay.minusDays(15));
        System.out.println("Trừ 5 tuần: " + toDay.minusWeeks(15));
        System.out.println("Trừ 5 tháng: " + toDay.minusMonths(15));
        System.out.println("Trừ 5 năm: " + toDay.minusYears(15));
        System.out.println("-----------------");
